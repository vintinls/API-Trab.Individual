package com.serratec.trabind.biblioteca.controller;
...
import com.serratec.trabind.biblioteca.repository.LivroRepository;
...
public class LivroController {
	...
	@PutMapping("{id}")
	public ResponseEntity<Livro> alterar(@PathVariable Long id, @Validated @RequestBody Livro livro){
